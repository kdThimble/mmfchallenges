...
import 'package:meetmefitchallenges/widgets/like_animation.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  void comments() async{
    await FirebaseFirestore.instance.collection('posts').doc(widget.snap['postId']).collection('comments').get().then((value) => {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // TODO: Brainstorm on whether a "Bookmark icon" is required for "Saving Posts"
            ],
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => CommentsScreen(snap: widget.snap,)),
                    );
                  },
                  child: Container(
